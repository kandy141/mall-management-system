						   ...
						   <ul>
							     ...
							     <?php
								  ...
								  while($row1=mysql_fetch_array($r1))
								  {
								   ...
								   if($c2=='a')
								   echo "<li><a href='remove_shop_form.php?val=$c1'>$c1</a></li>";
							       if($c2=='na')
								   echo "<li><a href='remove_shop_form.php?val=$c1'>$c1 &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp(Not Approved)</a></li>";
   	 ...
   	 <div class="wrap">
   	 	<div class="section group">
				...
				<div class="share-desc">
				   ...
				   <form method="post" id="myform" name="myform" action="remove_shop_db.php?id=<?php echo $id; ?>">
					<div class="button">
					  <span><input type="submit" name="remove" id="remove" value="Remove Shop"/></span>
					</div>					
					</form>
					<div class="clear"></div>
				</div>
