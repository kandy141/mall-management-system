...
<script>
 ...
 <form method="post" action="shopowner_register.php" onsubmit="return myFunction()">
    ...
    text-decoration: none;">  <b><i>Please register here ! </i></b></p></i><br>
	  ...
	  <tr><td>&nbsp</td><td>&nbsp</td><td><label for='name' ><h3>Shop Name</h3> </label></td>
	  <td><input type='text' name='shopname' id='shopname' maxlength="50" style="box-shadow:3px 3px 3px 3px #000;border-radius:7px"/></td></tr>
	  
	  <tr><td>&nbsp</td><td>&nbsp</td><td><label for='name' ><h3>Shop ID(User ID)</h3></label></td>
