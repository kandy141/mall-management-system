						   ...
						   <ul>
							     ...
							     <?php
								  ...
								  while($row1=mysql_fetch_array($r1))
								  {
								   $c1=$row1['category'];
								   ?>
								   <li><a href='remove_category_db.php?val=<?php echo $c1; ?>'><?php echo $c1;?></a></li>
							       <?php 
								  } 
						  	     ?>
							 </ul>
							...
							<br><br>
										<center>
											<p style="font-style: italic; font-weight:bold; font-family:'Times New Roman', Times, serif; font-size:200%">Select category to remove</p>
										</center>	
							  <!------End Slider ------------>
		        </div>
   </div>
