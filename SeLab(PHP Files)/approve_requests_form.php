					...
					<div class="header_bottom_left">				
						<div class="categories">
						   <ul>
							     ...
							     <?php
								  $q1 = "SELECT * from admin_approval where status='na'";
								  $r1 = mysql_query($q1) or die(mysql_error());
								  while($row1=mysql_fetch_array($r1))
								  {
								   $c1=$row1['user_id'];
								   ?>
								   <li><a href='approve_requests_form.php?val=<?php echo $c1; ?>'><?php echo $c1;?></a></li>
							       <?php 
								  } 
						  	     ?>
							 </ul>
   	 ...
   	 <div class="wrap">
   	 	<div class="section group">
				...
				<div class="share-desc">
				   ...
				   <form method="post" id="myform" name="myform" action="approve_requests_db.php?id=<?php echo $id; ?>">
					<div class="button">
					  <span><input type="submit" name="Approve" id="Approve" value="Approve"/></span>
					</div>					
					</form>
					<div class="clear"></div>
				</div>
